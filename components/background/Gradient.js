export function BottomGradient() {
  return (
    <svg
      className="fixed bottom-0 left-10 pointer-events-none -z-10 hidden lg:block"
      width="1440"
      height="882"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#9FC4D3" stopOpacity="0"></stop>
          <stop offset="0.0001" stopColor="#9EE3FF" stopOpacity="0"></stop>
          <stop offset="1" stopColor="#D49DFF"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
...
export function CornerGradient() {
  return (
    <svg
      className="fixed bottom-0 left-0 pointer-events-none -z-20 hidden lg:block"
      width="863"
      height="900"
      viewBox="0 0 863 900"
      fill="none"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="#9FC4D3" stopOpacity="0"></stop>
          <stop offset="0.0001" stopColor="#9EE3FF" stopOpacity="0"></stop>
          <stop offset="1" stopColor="#B8E5FF"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
